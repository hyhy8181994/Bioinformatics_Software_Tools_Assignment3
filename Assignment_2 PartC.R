...
plot(mapplot,fsize=0.01,asp=1.2,type="phylogram",ftype="i") library(tidyverse)
library(rentrez)
library(Biostrings)
library(muscle)
library(DECIPHER)
...
#the tree is bit different from the tree constructed by Maximum parsimony phylogenies and it group few species into the wrong group
mapplot <- plot(mapplot,fsize=0.01,asp=1.2,type="phylogram",ftype="i")

# the phylogenetic tree plot along with geological information
